...
import com.globo.globonetwork.cloudstack.api.AddNetworkAPIEnvironmentCmd;
import com.globo.globonetwork.cloudstack.api.AddNetworkAPIVipToAccountCmd;
import com.globo.globonetwork.cloudstack.api.AddNetworkApiHostCmd;
import com.globo.globonetwork.cloudstack.api.AddNetworkApiRealToVipCmd;
import com.globo.globonetwork.cloudstack.api.AddNetworkApiVlanCmd;
import com.globo.globonetwork.cloudstack.api.AddNetworkViaNetworkApiCmd;
import com.globo.globonetwork.cloudstack.api.DelNetworkApiRealFromVipCmd;
import com.globo.globonetwork.cloudstack.api.GenerateUrlForEditingVipCmd;
import com.globo.globonetwork.cloudstack.api.ListAllEnvironmentsFromNetworkApiCmd;
import com.globo.globonetwork.cloudstack.api.ListNetworkApiEnvironmentsCmd;
import com.globo.globonetwork.cloudstack.api.ListNetworkApiRealsCmd;
import com.globo.globonetwork.cloudstack.api.ListNetworkApiVipsCmd;
import com.globo.globonetwork.cloudstack.api.RemoveNetworkAPIEnvironmentCmd;
import com.globo.globonetwork.cloudstack.api.RemoveNetworkAPIVipCmd;
import com.globo.globonetwork.cloudstack.commands.ActivateNetworkCommand;
import com.globo.globonetwork.cloudstack.commands.AddAndEnableRealInNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.CreateNewVlanInNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.DeallocateVlanFromNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.DisableAndRemoveRealInNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.GenerateUrlForEditingVipCommand;
import com.globo.globonetwork.cloudstack.commands.GetVipInfoFromNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.GetVlanInfoFromNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.ListAllEnvironmentsFromNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.NetworkAPIErrorAnswer;
import com.globo.globonetwork.cloudstack.commands.RegisterEquipmentAndIpInNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.RemoveNetworkInNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.RemoveVipFromNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.UnregisterEquipmentAndIpInNetworkAPICommand;
import com.globo.globonetwork.cloudstack.commands.ValidateNicInVlanCommand;
import com.globo.globonetwork.cloudstack.dao.NetworkAPIEnvironmentDao;
import com.globo.globonetwork.cloudstack.dao.NetworkAPINetworkDao;
import com.globo.globonetwork.cloudstack.dao.NetworkAPIVipAccDao;
import com.globo.globonetwork.cloudstack.exception.CloudstackNetworkAPIException;
import com.globo.globonetwork.cloudstack.resource.NetworkAPIResource;
import com.globo.globonetwork.cloudstack.response.NetworkAPIAllEnvironmentResponse;
import com.globo.globonetwork.cloudstack.response.NetworkAPIAllEnvironmentResponse.Environment;
import com.globo.globonetwork.cloudstack.response.NetworkAPIVipResponse;
import com.globo.globonetwork.cloudstack.response.NetworkAPIVipResponse.Real;
import com.globo.globonetwork.cloudstack.response.NetworkAPIVlanResponse;
...
//		CallContext.register(CallContext.current().getCallingUserId(), owner.getAccountId());
	...
	public List<Class<?>> getCommands() {
		...
		cmdList.add(ListNetworkApiRealsCmd.class);
		return cmdList;
	}
	...
	public List<NetworkAPIVipResponse> listNetworkAPIVips(Long projectId) {
		...
		for (NetworkAPIVipAccVO napiVipAcc : napiVipAccList) {
			...
			if (vips.get(napiVipAcc.getNapiVipId()) == null) {
				...
				vip =  ((NetworkAPIVipResponse) answer);
		...
		return new ArrayList<NetworkAPIVipResponse>(vips.values());
	}
	...
	public List<NetworkAPIVipResponse.Real> listNetworkAPIReals(Long vipId) {
		...
		List<NetworkAPIVipAccVO> napiVips = _napiVipAccDao.findByVipId(vipId);

		if (napiVips == null) {
			throw new CloudRuntimeException("Could not find VIP " + vipId);
		}
		
		List<NetworkAPIVipResponse.Real> reals = new ArrayList<NetworkAPIVipResponse.Real>();
		...
		for (Real real : vip.getReals()) {
			for (NetworkAPIVipAccVO napiVipVO : napiVips) {
