...
@APICommand(name = "addNetworkAPIEnvironment", responseObject = NetworkAPIEnvironmentResponse.class, description = "Adds a NetworkAPI environment to a zone")
public class AddNetworkAPIEnvironmentCmd extends BaseAsyncCmd {
