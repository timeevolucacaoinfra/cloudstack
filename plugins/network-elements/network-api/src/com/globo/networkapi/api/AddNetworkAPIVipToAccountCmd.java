...
public class AddNetworkAPIVipToAccountCmd extends BaseCmd {

    public static final Logger s_logger = Logger.getLogger(AddNetworkAPIVipToAccountCmd.class.getName());
