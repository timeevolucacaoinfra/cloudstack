...
@Component
@Local(value = {NetworkElement.class, LoadBalancingServiceProvider.class, GslbServiceProvider.class})
public class GloboNetworkElement extends ExternalLoadBalancerDeviceManagerImpl implements LoadBalancingServiceProvider, IpDeployer, GslbServiceProvider,
    ...
    public boolean isServiceEnabledInZone(long zoneId, long physicalNetworkId) {
        return _globoNetworkService.canEnable(physicalNetworkId);
    }
    ...
    public boolean applyGlobalLoadBalancerRule(long zoneId, long physicalNetworkId, GlobalLoadBalancerConfigCommand gslbConfigCmd) throws ResourceUnavailableException {
        s_logger.info("zoneId=" + zoneId + " physicalNetworkId=" + physicalNetworkId + " gslbConfigCmd=" + gslbConfigCmd);
        return false;
    }
