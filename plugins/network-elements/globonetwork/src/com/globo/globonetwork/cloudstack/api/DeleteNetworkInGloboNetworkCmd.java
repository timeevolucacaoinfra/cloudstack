...
@APICommand(name = "deleteNetworkInGloboNetwork", description = "Deletes a GloboNetwork network", responseObject = SuccessResponse.class, entityType = {Network.class}, requestHasSensitiveInfo = false, responseHasSensitiveInfo = false)
public class DeleteNetworkInGloboNetworkCmd extends BaseAsyncCmd {
    ...
    @Inject
    GloboNetworkService _glbNetService;
