...
public class NetworkAPIVipAccVO implements InternalIdentity {
	...
	public NetworkAPIVipAccVO() {
	}

	public NetworkAPIVipAccVO(long napiVipId, long accountId, long networkId) {
